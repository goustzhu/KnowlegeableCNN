...
from DocEmbeddingNNMultInput import DocEmbeddingNN
...
def work(mode, data_name, test_dataname, pooling_mode="average_exc_pad"):
	...
	# for list-type data
# 	layer0Word = DocNN(corpus, sentenceWordCount, rng, embeddingDim=200, \
# 													 nodesNum=50, \
# 													 nodesSize=[5, 200], \
# 													 pooling_mode=pooling_mode)
# 	layer0Pos = DocNN(corpusPos, sentenceWordCount, rng, embeddingDim=49, \
# 													 nodesNum=50, \
# 													 nodesSize=[5, 49], \
# 													 pooling_mode=pooling_mode)
# 
# 	layer0_sentence = T.concatenate([layer0Word.output, layer0Pos.output], axis=1)
	layer0 = DocEmbeddingNN(corpus, corpusPos, docSentenceCount, sentenceWordCount, rng, \
													wordEmbeddingDim=200, posEmbeddingDim=49,\
													 sentenceLayerNodesNum=50, \
													 sentenceLayerNodesSize=[5, 200], \
													 posLayerNodesNum=50, \
													 posLayerNodesSize=[5, 49], \
													 docLayerNodesNum=10, \
...
# 	data_name = "car"
	...
	para_path = "data/" + data_name + "/model/multi_input" + pooling_mode + ".model"
